...
#[command(
    version,
    about = "Secure CI/CD workflows by pinning dependencies to immutable hashes.",
    long_about = "Secure CI/CD workflows by pinning mutable tags to immutable SHA-1 hashes. A high-performance Rust CLI that preserves YAML formatting and comments. Supports GitHub, GitLab, Bitbucket, Forgejo, and Docker image pinning."
)]
pub struct Cli {
